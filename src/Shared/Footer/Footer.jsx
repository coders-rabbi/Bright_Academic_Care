        ...
        <div className='xl:grid grid-cols-3 bg-[#EEF3F1] py-12 xl:py-28 p-5 xl:px-0'>
            <div className='xl:flex justify-center'>
                <div>
                    ...
                    <button className='mt-8 flex justify-center items-center gap-2 text-white p-1.5 rounded-xl px-3 bg-[#F68319]'>
                        <Link>যোগাযোগ</Link>
            ...
            <div className='xl:flex justify-around text-black mt-5 xl:mt-0'>
                <div className='border-r pe-4'>
                    <h2 className='mb-7 text-xl font-semibold'>দ্রুত লিংক</h2>
                    <ul>
                        <li className='mt-4'>হোম</li>
                        <li className='mt-4'>আমাদের সম্পর্কে</li>
                        <li className='mt-4'>কোর্স সমূহ</li>
                        <li className='mt-4'>শিক্ষকমন্ডলী</li>
                        <li className='mt-4'>সংবাদ</li>
                        <li className='mt-4'>গ্যালারি</li>
                    </ul>
                </div>
                <div className='border-r pr-4 mt-5 xl:mt-0'>
                    <h2 className='mb-7 text-xl font-semibold'>কোর্স সমূহ</h2>
                    <ul>
                        <li className='mt-4'>প্রাথমি শিক্ষা</li>
                        <li className='mt-4'>মাধ্যমিক শিক্ষা</li>
                        <li className='mt-4'>উচ্চ মাধ্যমিক</li>
                        <li className='mt-4'>কম্পিউটার কোর্স</li>
                    </ul>
                </div>
            </div>

            <div className='text-black mt-5 xl:mt-0'>
                <h2 className='mb-7 text-xl font-semibold'>যোগাযোগ</h2>
                <p className='font-semibold mt-4'>phone: <small>০১৭১৬৬১১২০৮</small></p>
                <p className='font-semibold mt-4'>phone: <small>০১৭১৬৬১১২০৮</small></p>
                <p className='font-semibold mt-4'>Emainl: <small>info@brightacademiccare.com</small></p>
                <p className='font-semibold mt-4'>phone: <small>০১৭১৬৬১১২০৮</small></p>
                <p className='font-semibold mt-4'>Location: <small>ঢাকা, বাংলাদেশ</small></p>
