...
const EvenSection = () => {
    return (
        <div className='xl:p-10 py-10 px-5 bg-white'>
            <div className='text-center'>
                <p className='border bg-white border-[#F5F5F5] rounded-xs shadow-2xl inline-block py-2 px-4 border-l-3 border-l-[#F68319] mb-2 text-black'>সংবাদ ও ঘোষণা</p>
                <h2 className='text-3xl font-semibold mt-4 text-black'>সাম্প্রতিক আপডেট ও গুরুত্বপূর্ণ তথ্য</h2>
            </div>

            {/* card section */}
            <div className='xl:grid grid-cols-4 gap-5 mt-8'>
