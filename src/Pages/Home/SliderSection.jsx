...
const SliderSection = () => {
    return (
        <Swiper spaceBetween={30} slidesPerView={1}>
            {[1, 2, 3, 4].map((_, index) => (
                <SwiperSlide key={index} className="bg-[#FEF6EF] py-10">
                    <div className="flex flex-col xl:flex-row items-center justify-center gap-8 px-4 xl:px-0">
                        ...
                        <div className="order-1 xl:order-2 text-center xl:text-left max-w-xl">
                            <p className="inline-block text-black bg-white shadow-md py-2 px-4 border-l-4 border-[#F68319] text-sm mb-3">
                                আমাদের কোর্স সমূহ
                            </p>
                            ...
                            <p className="text-[12px] xl:text-sm text-black mt-4">
                                "এখানকার শিক্ষা পদ্ধতি অনেক আধুনিক। গণিত আর বিজ্ঞানে আমার দুর্বলতা কাটিয়ে
                                উঠতে পেরেছি। এখন আমি ক্লাসে প্রথম হই।"
                            </p>

                            <div className="flex justify-center xl:justify-start items-center gap-3 mt-4 text-black">
